    ...
    const fetchAnalyticsData = async () => {
      try {
        ...
        if (response.data && response.data.analyticsData) {
          ...
          console.error("Invalid analytics data response:", response.data);
        }
  
        if (response.data && response.data.dailySalesData) {
          setDailySalesData(response.data.dailySalesData);
        } else {
          console.error("Invalid daily sales data response:", response.data);
        }
      } catch (error) {
